...
static constexpr size_t SYMMETRIC_KEY_SIZE_BYTES = 32; // 256 bits for AES-256
static constexpr size_t HMAC_SIZE_BYTES = 32; // 256 bits for SHA-256
static constexpr size_t SIGNATURE_SIZE_BYTES = 384; // 3072 bits RSA signature
static constexpr size_t DH_KEY_SIZE_BYTES = 1149; // 3072 bits Diffie-Hellman key
